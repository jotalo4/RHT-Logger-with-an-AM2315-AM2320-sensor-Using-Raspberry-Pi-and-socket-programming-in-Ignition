...
class Environmental_data_logger(object):
    ...
    def log(self, entry_index, temperature, fahrenheit, humidity):
        ...
        try:
            ...
            if os.path.isfile(self.file_path):
                ...
                self.fo.writelines("Index, Temperature(C), Temperature (F), Relative Humidity (%), " + " \n")

            self.fo.writelines(
                str(entry_index) + ", " + str(temperature) + ", " + str(fahrenheit) + "," + str(humidity) + " \n")
...
print("before  Environmental_data_logger_unit_test()")

if __name__ == '__main__':
    print("before  Environmental_data_logger_unit_test()")
    # Envirenmental_data_logger_unit_test()
    obj_data_logger = Environmental_data_logger("log.txt")
    i = 0
    while i < 1000:
        i += 1
