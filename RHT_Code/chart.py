...
#modified: Orukotan, Ayomikun Samuel
...
class Chart(Canvas):
    ...
    #pass an integer to this function to set the number of data points to be displayed
    ...
    #private
    #loops through the list of data and finds min and max
