...
class AM2320:
 ...
 # Constructor to set up the class
    def __init__(self):
        ...
        #The POrt number of the i2cbus
        #self.i2cbus = smbus.SMBus(i2cbus)
...
#may need tweaking or may possibly be turned down a bit.
        time.sleep(0.0015) #Wait at least 1.5ms for result
...
# Convert the temperature to Fahrenheit
                self.fahrenheit = ((9.0 * self.temperature) / 5.0) + 32 
